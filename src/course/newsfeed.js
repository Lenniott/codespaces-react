          ...
          <div class="lg:grid lg:grid-cols-4 lg:gap-6">
            <div className="lg:col-span-3">
              <section className="bg-white p-6 space-y-6">
                <div className="text-xl">Text Mining for Economics and Finance</div>
                <p>Welcome to your new course. This is the course newsfeed where you can post news for students. Click below to add your first post.</p>
            ...
            <aside className="hidden lg:block">
              <div class="self-start grid gap-6">
                <section class="bg-white p-6">
                  ...
                  <div>This is a course summary. It is usually longer than this.</div>
                </section>
                <section class="bg-white p-6">
                ...
                <section class="bg-white p-6">
                  ...
                  <ul className="text-sm divide-y text-neutral-500 -mb-3">
                    <li class="group flex items-center space-x-3 py-3">
                      <img src="https://randomuser.me/api/portraits/women/79.jpg" alt="Team member" class="h-10 w-10 flex-none rounded-full" />
                      <div class="flex-auto">
                    ...
                    <li class="group flex items-center space-x-3 py-3">
                      <img src="https://randomuser.me/api/portraits/men/79.jpg" alt="Team member" class="h-10 w-10 flex-none rounded-full" />
                      <div class="flex-auto">
